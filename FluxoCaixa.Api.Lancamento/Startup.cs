...
using FluxoCaixa.Api.Lancamento.Helpers;
using Microsoft.OpenApi.Models;
using System.Text.Json.Serialization;
using System.Text.RegularExpressions;
using static FluxoCaixa.Ioc.Lancamento.Bootstraper;

namespace FluxoCaixa.Api.Lancamento
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "FluxoCaixa Api Lançamentos",
                    Version = "v1",
                    Description = $"FluxoCaixa Api Lançamentos - Version: {AppVersionService.Version}",
